...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center pb-3 mb-4 border-bottom border-secondary">
        <h1 class="h3 mb-0 text-white">
            <i class="bi bi-pencil-square me-2"></i> Edit Kas Masuk
        </h1>
    ...
    <div class="dashboard-card p-4">
        <form method="post" action="<?= site_url('admin/kas_masuk/update/' . $kas['id']) ?>" class="needs-validation" novalidate>
            <?= csrf_field() ?>
            <div class="row g-3">
                <!-- Nominal Input -->
                <div class="col-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text"
                            ...
                            value="<?= old('nominal', number_format($kas['nominal'], 0, ',', '.')) ?>"
                            required>
