...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center pb-3 mb-5 border-bottom">
        ...
        <a href="<?= site_url('admin/kas_masuk/create') ?>" class="btn btn-gradient-primary shadow-sm btn-add-user mb-2">
    ...
    <div class="row mb-3 g-2">
        ...
        <div class="col-md-9 d-flex align-items-center gap-2">
            <div class="modern-search flex-grow-1 d-flex align-items-center">
                ...
                <input type="text" id="searchInput" class="form-control form-control-sm w-100" placeholder="Cari keterangan kas masuk...">
            </div>
